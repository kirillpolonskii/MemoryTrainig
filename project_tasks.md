...
+ Сделать DetailsSettingsActivity
  ...
  + ~~Построить интерфейс фрагмента для списка вопросов и элемента списка вопросов~~</font>
  + Построить интерфейс фрагмента для добавления вопроса
...
+ Сделать DetailsSettingsActivity
  + Добавить логику сохранения настроек
  + Реализовать класс Question и адаптер для RecyclerView в NewQuestionsListFragment
  + Сделать NewQuestionFragment
    + Написать логику замены edittext добавления текста вопроса на edittext добавления варианта ответа
