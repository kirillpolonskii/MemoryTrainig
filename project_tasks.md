...
+ Сделать DetailsSettingsActivity
  + Построить интерфейс ~~активности выбора картинки~~ и активности добавления коллекции вопросов
...
+ Сделать AddPhrasesCollectionActivity
  ...
  + ~~Написать логику сохранения коллекции~~</font>
  + Написать логику активации/дезактивации кнопок в зав-ти от текущего фрагмента
+ Сделать DetailsSettingsActivity
+ Добавить кнопку info на каждую активность настроек для показа диалогового окна инструкций
+ Сделать Statistics
